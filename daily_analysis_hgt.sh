...
# ============================================================
#  每日股票分析脚本 - 沪股通
#  用法: ./daily_analysis_hgt.sh
#  说明: 分析沪股通 Top 20 + 自选股，生成报告和图表
# ============================================================
...
# discover 参数
POOL="hgt"            # 股票池: hgt(沪股通) / sgt(深股通) / sz50 / hs300 / cyb / chip / newenergy / ai / ev
MIN_SCORE=15          # 最低分数阈值
TOP_N=20              # 显示前 N 名
...
echo "📊 [1/3] 潜力股发现 (${POOL}, Top ${TOP_N}, >= ${MIN_SCORE}分)"
echo "------------------------------------------------------------"
